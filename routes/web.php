...
Route::post('qrLogin', ['uses' => 'QrLoginController@checkUser']);
 ...
 Route::group(['middleware' => ['web', 'auth', 'permission'] ], function () {
        ...
        Route::get('/qr-codes','HomeController@viewQrs');
        Route::get('/user-search','HomeController@userSearch');
        Route::post('/user-search','HomeController@handleUserSearch');
        Route::get('/attendance','HomeController@attendance');
        Route::post('/sort-date','HomeController@sortdate');
 });
